...
const mockSupabaseClient = vi.mocked(await import("../../lib/supabase.client")).createBrowserSupabaseClient;
...
describe("auth.direct service", () => {
  ...
  describe("resetPassword", () => {
    it("should initiate password reset successfully", async () => {
      ...
      // Use objectContaining to avoid URL issues
      expect(mockAuth.resetPasswordForEmail).toHaveBeenCalledWith("user@example.com", expect.objectContaining({}));
